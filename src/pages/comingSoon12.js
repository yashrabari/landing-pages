      ...
      <Helmet>
        <style>
          ...
          @font-face {
              ...
              src: url(${process.env.PUBLIC_URL +
                "/assets/fonts/SteelfishRg-Bold/SteelfishRg-Bold.eot?#iefix"}) format("embedded-opentype"),
              url(${process.env.PUBLIC_URL +
                "/assets/fonts/SteelfishRg-Bold/SteelfishRg-Bold.woff2"}) format("woff2"),
              url(${process.env.PUBLIC_URL +
                "/assets/fonts/SteelfishRg-Bold/SteelfishRg-Bold.woff"}) format("woff"),
              url(${process.env.PUBLIC_URL +
                "/assets/fonts/SteelfishRg-Bold/SteelfishRg-Bold.ttf"}) format("truetype"),
              url(${process.env.PUBLIC_URL +
                "/assets/fonts/SteelfishRg-Bold/SteelfishRg-Bold.svg#SteelfishRg-Bold"}) format("svg");
          }
          ...
          @font-face {
            ...
            src: url(${process.env.PUBLIC_URL +
              "/assets/fonts/SteelfishEb-Regular/SteelfishEb-Regular.eot?#iefix"}) format('embedded-opentype'),
                url(${process.env.PUBLIC_URL +
                  "/assets/fonts/SteelfishEb-Regular/SteelfishEb-Regular.woff2"}) format('woff2'),
                url(${process.env.PUBLIC_URL +
                  "/assets/fonts/SteelfishEb-Regular/SteelfishEb-Regular.woff"}) format('woff'),
                url(${process.env.PUBLIC_URL +
                  "/assets/fonts/SteelfishEb-Regular/SteelfishEb-Regular.ttf"}) format('truetype'),
                url(${process.env.PUBLIC_URL +
                  "/assets/fonts/SteelfishEb-Regular/SteelfishEb-Regular.svg#SteelfishEb-Regular"}) format('svg');
          }
